  ...
  Future<List<prodModal>> getAllPost(String key) async {
   // print(key);
    Response res = await get(Uri.parse(
        "http://siddharth1212-37666.portmap.host:37666/healinghand/doctorlist.php?key=$key"));
...
Future<List<prodModal2>> getAllPost2(String key) async {
   ...
   // print(key);
    Response res = await get(Uri.parse(
        "http://siddharth1212-37666.portmap.host:37666/healinghand/getappoinment.php"));
    if (res.statusCode == 200) {
  ...
  Future<List<prodModal1>> getAllPost3(var e) async {
    Response res = await get(
        Uri.parse("http://siddharth1212-37666.portmap.host:37666/healinghand/getreview.php?key="+e));
    if (res.statusCode == 200) {
      //Map<String,dynamic> data1 = jsonDecode(res.body);
  ...
  Future<List<prodModal3>> getAllPost5(var e) async {
    Response res = await get(
        Uri.parse("http://siddharth1212-37666.portmap.host:37666/healinghand/getuser.php?email="+e));
    if (res.statusCode == 200) {
      //Map<String,dynamic> data1 = jsonDecode(res.body);
  ...
  Future saverec (String email,String phoneno,String date,String time,String status,String purpose) async {
     print(email);
        ...
        print(purpose);
    var request = http.MultipartRequest(
        'POST', Uri.parse("http://siddharth1212-37666.portmap.host:37666/healinghand/appoinment.php"));
  ...
  Future saverec1(String pmail,String umail,String review) async {
    ...
    var request = http.MultipartRequest('POST',
        Uri.parse("http://siddharth1212-37666.portmap.host:37666/healinghand/addreview.php"));
